...
def preprocession(file_name='lstm_input/price_withdate.csv', date_index=0, start_column_index = 1, end_column_index = 4 ):
    """
...
def train_lstm(train_time,batch_size=60, time_step=5, train_begin=0):
    ...
    with tf.Session() as sess:
        ...
        print("model_save: ", saver.save(sess, 'models_lstm\\modleMutil.ckpt'))
...
def prediction(train_time,time_step=5):
    ...
    with tf.Session() as sess:
        # 参数恢复
        module_file = tf.train.latest_checkpoint('models_lstm')
