...
if __name__ == '__main__':
    price_path = os.path.join("lstm_input/selfprice.csv")
    time_path = os.path.join("lstm_input/sh.601601_train_data.csv")
    save_path = os.path.join("lstm_input/price_withdate.csv")
    unified_path = os.path.join("lstm_input/unified_results_new.csv")
    num_index = 0
    date_index = 0
